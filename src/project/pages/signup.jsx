  ...
  return (
    ...
    <>
     <ToastContainer />
      ...
      <img src={shopImage} alt="shop logo"  className=" mx-auto"/>
        <h1 className="text-center text-purple-500 text-2xl font-bold my-6">
          Sign Up
        </h1>
        {displayErrors()}
          <div className="relative z-0 w-full mb-5 group">
            ...
            >
              <i class="fas fa-user icon pr-2"></i>Username
            </label>
          </div>
        ...
        <div className="relative z-0 w-full mb-5 group">
          ...
          <label
            ...
            className="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
          >
            <i class="fas fa-envelope icon pr-2"></i>Email address
          </label>
        </div>
        <div className="relative z-0 w-full mb-5 group">
          <input
          ...
          <label
            ...
            className="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
          >
            <i class="fas fa-phone icon pr-2"></i>Phone number
          </label>
        </div>
        <div className="relative z-0 w-full mb-5 group">
          <select
          ...
          <label
            ...
            className="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
          >
            <i class="fas fa-globe icon pr-2"></i>Country
          </label>
        </div>
        <div className="grid md:grid-cols-2 md:gap-6">
          <div className="relative z-0 w-full mb-5 group">
            ...
            <label
              ...
              className="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >
              <i class="fas fa-key icon pr-2"></i>Password
            </label>
          </div>
          <div className="relative z-0 w-full mb-5 group">
            <input
            ...
            <label
              ...
              className="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >
              <i class="fas fa-lock icon pr-2"></i>Confirm password
            </label>
          </div>
        </div>
        ...
        <button
          type="submit"
          className="text-white mx-40 bg-purple-600 hover:bg-purple-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none"
        >
